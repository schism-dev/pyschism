...
from pyschism.mesh.boundaries import HgridBoundaries
...
#                     f'type {type(obj)}.')
#         raise NotImplementedError('set_forcing')
#         if iettype is not None:
#             check_input_type('iettype', iettype, Iettype)
#             self.open.iloc['id' == boundary_id]
#         check_input_type('ifltype', ifltype, Ifltype)
#         check_input_type('itetype', itetype, Itetype)
#         check_input_type('isatype', isatype, Isatype)
#         check_input_type('itrtype', itrtype, Itrtype)
